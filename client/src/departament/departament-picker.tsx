...
function DepartamnetPicker({onChange, className}: LocalParams) {
    ...
    return <SelectionPlate<Departament> className={className ?? "flex gap-4 px-4 py-1"} closeAfterSubmit searchPanelLabel="назва відділу" filterField={departamentFilterField} label="відділення" name="departament" displayField={departamentsDisplayField} fetchData={getDepartaments} onChange={onChange}/>
}
